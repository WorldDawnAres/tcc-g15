...
- [Thermal Control Center for Dell G15 (and others)](#thermal-control-center-for-dell-g15-and-others)
  - [Target Platform](#target-platform)
  - [What It Can Do](#what-it-can-do)
  - [UI hints](#ui-hints)
  - [Limitations](#limitations)
  - [Why AWCC is BAD](#why-awcc-is-bad)
  - [How It Works](#how-it-works)
  - [How to Run from the Source](#how-to-run-from-the-source)
  - [About the AWCC Telemetry](#about-the-awcc-telemetry)
  - [Credits](#credits)
  - [Changelog](#changelog)
  - [License](#license)
...
[Download link](https://github.com/WorldDawnAres/tcc-g15/releases) *(Note: the app requires administrator privileges)*

![Screenshot 1](./screen-1.png "Screenshot 1")

![Screenshot 1](./screen-2.png "Screenshot 2")
...
- The white dots ("stars") in the corners of the tray icon indicate current G mode state.
    ...
    ![Screenshot 1](./g_off.png "g_off")  G mode is Off ![Screenshot 1](./g_on.png "g_on") G mode is On
...
I have somewhat documented my findings on the WMI [WMI-AWCC-doc.md](WMI-AWCC-doc.md).
